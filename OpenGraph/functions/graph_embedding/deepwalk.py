...
from OpenGraph.functions.graph_embedding.node2vec import learn_embeddings
from OpenGraph.functions.graph_embedding.node2vec import _get_embedding_result_from_gensim_skipgram_model
import random
